...
*/
void maze_print(unsigned char labyrinth[100][100],uint8_t size_x,uint8_t size_y);
...
*	  4 sonstige Fehler
*/
int maze_from_file(char* filename,unsigned char labyrinth[100][100],uint8_t *size_x,uint8_t *size_y);
...
*/
struct Point maze_start_pos(unsigned char labyrinth[100][100],uint8_t size_x,uint8_t size_y);
